  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        hero: {
          canvas: "hsl(var(--hero-canvas))",
          foreground: "hsl(var(--hero-foreground))",
          muted: "hsl(var(--hero-muted))",
          subtle: "hsl(var(--hero-subtle))",
          glass: "hsl(var(--hero-glass))",
          "glass-strong": "hsl(var(--hero-glass-strong))",
          panel: "hsl(var(--hero-panel))",
          border: "hsl(var(--hero-border))",
          violet: "hsl(var(--hero-violet))",
          pink: "hsl(var(--hero-pink))",
          cyan: "hsl(var(--hero-cyan))",
          online: "hsl(var(--hero-online))",
          accent: "hsl(var(--hero-pink))",
          "action-foreground": "hsl(var(--hero-action-foreground))",
        },
        primary: {
      ...
      boxShadow: {
        ...
        'hero-card':    'var(--hero-shadow-card)',
        'hero-action':  'var(--hero-shadow-action)',
        'hero-pink':    '0 0 14px hsl(var(--hero-pink) / 0.75)',
        'hero-online':  '0 0 12px hsl(var(--hero-online) / 0.75)',
      },
      backgroundColor: {
        'hero-action': 'hsl(var(--hero-violet))',
      },
      backgroundImage: {
        'hero-title': 'var(--hero-title)',
        'hero-action': 'var(--hero-action)',

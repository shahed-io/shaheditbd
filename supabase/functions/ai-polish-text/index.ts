...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const langInstr =
      lang === 'bn'
        ? 'Write the improved text in natural Bengali (বাংলা). Use "শাহেদ স্টোর" for the brand name; natural case markers (এর/কে/তে) are OK on the Bengali brand name only, never on English "Shahed Store".'
        : 'Write the improved text in clean English. Use exactly "Shahed Store" for the brand name.';

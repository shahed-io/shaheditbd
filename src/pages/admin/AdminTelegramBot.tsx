...
const AdminTelegramBot = () => {
  ...
  const fetchData = async () => {
    ...
    if (!map['telegram_shop_bot_welcome']) map['telegram_shop_bot_welcome'] = '🛍️ শাহেদ স্টোর এ স্বাগতম! আমাদের টেলিগ্রাম বট দিয়ে সরাসরি শপিং করুন।';
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="🛍️ শাহেদ স্টোর এ স্বাগতম!"

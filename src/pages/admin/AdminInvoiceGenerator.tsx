                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px', borderRadius: '8px', overflow: 'hidden' }}>
                  <thead>
                    <tr style={{ background: brandColor }}>
                      <th style={{ color: '#ffffff', fontSize: '14px', fontWeight: 900, letterSpacing: '0.3px', padding: '16px 14px', textAlign: 'left', background: brandColor, textShadow: '0 2px 4px rgba(0,0,0,0.5)', WebkitTextStroke: '0.3px #ffffff' }}>#</th>
                      <th style={{ color: '#ffffff', fontSize: '14px', fontWeight: 900, letterSpacing: '0.3px', padding: '16px 14px', textAlign: 'left', background: brandColor, textShadow: '0 2px 4px rgba(0,0,0,0.5)', WebkitTextStroke: '0.3px #ffffff' }}>পণ্যের নাম</th>
                      <th style={{ color: '#ffffff', fontSize: '14px', fontWeight: 900, letterSpacing: '0.3px', padding: '16px 14px', textAlign: 'center', background: brandColor, textShadow: '0 2px 4px rgba(0,0,0,0.5)', WebkitTextStroke: '0.3px #ffffff' }}>পরিমাণ</th>
                      <th style={{ color: '#ffffff', fontSize: '14px', fontWeight: 900, letterSpacing: '0.3px', padding: '16px 14px', textAlign: 'right', background: brandColor, textShadow: '0 2px 4px rgba(0,0,0,0.5)', WebkitTextStroke: '0.3px #ffffff' }}>দাম</th>
                      <th style={{ color: '#ffffff', fontSize: '14px', fontWeight: 900, letterSpacing: '0.3px', padding: '16px 14px', textAlign: 'right', background: brandColor, textShadow: '0 2px 4px rgba(0,0,0,0.5)', WebkitTextStroke: '0.3px #ffffff' }}>মোট</th>
                    </tr>
                  </thead>
                  <tbody>
                    {items.map((item, idx) => (

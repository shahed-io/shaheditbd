    ...
    items: [
      {
        ...
        helpSlug: 'how-to-order',
        helpLabel: 'অর্ডার প্রক্রিয়া বিস্তারিত',
      },
      {
        ...
        helpSlug: 'delivery-time',
        helpLabel: 'ডেলিভারি সময় সম্পর্কে বিস্তারিত',
      },
      {
        ...
        helpSlug: 'track-order',
        helpLabel: 'অর্ডার ট্র্যাকিং গাইড',
      },
      {
        ...
        helpSlug: 'cancel-order',
        helpLabel: 'বাতিল ও এক্সচেঞ্জ নীতি',
      },
      {
    ...
    items: [
      {
        ...
        helpSlug: 'payment-methods',
        helpLabel: 'পেমেন্ট মেথড গাইড',
      },
      {
        ...
        helpSlug: 'after-payment',
        helpLabel: 'পেমেন্টের পরের ধাপসমূহ',
      },
      {
        ...
        helpSlug: 'wrong-payment',
        helpLabel: 'ভুল পেমেন্ট সমস্যা সমাধান',
      },
      {
        q: 'পেমেন্ট কি নিরাপদ?',
        ...
        helpSlug: 'payment-security',
        helpLabel: 'পেমেন্ট নিরাপত্তা নীতি',
      },
      {
    ...
    items: [
      {
        ...
        helpSlug: 'digital-delivery',
        helpLabel: 'ডিজিটাল ডেলিভারি প্রক্রিয়া',
      },
      {
      ...
      },
      {
        ...
        helpSlug: 'night-delivery',
        helpLabel: 'রাতের ডেলিভারি সম্পর্কে',
      },
      {
        ...
        helpSlug: 'missing-delivery',
        helpLabel: 'ডেলিভারি না পেলে কী করবেন',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        helpSlug: 'refund-policy',
        helpLabel: 'রিফান্ড পলিসি বিস্তারিত',
      },
      {
        ...
        helpSlug: 'refund-timeline',
        helpLabel: 'রিফান্ড প্রক্রিয়া ও সময়সীমা',
      },
      {
        ...
        helpSlug: 'license-not-working',
        helpLabel: 'লাইসেন্স সমস্যা সমাধান',
      },
      {
        ...
        helpSlug: 'return-policy',
        helpLabel: 'রিটার্ন পলিসি বিস্তারিত',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        helpSlug: 'create-account',
        helpLabel: 'অ্যাকাউন্টের সুবিধাসমূহ',
      },
      {
        ...
        helpLabel: 'পাসওয়ার্ড রিসেট গাইড',
      },
      {
        ...
        helpLabel: 'রেফারেল প্রোগ্রাম বিস্তারিত',
      },
    ],
  },
];
  ...
  >
    ...
    >
      <div className="px-5 pb-4 pt-0">
        ...
        <p className="text-[13px] leading-relaxed mb-3" style={{ color: 'hsl(226,35%,38%)' }}>
          {item.a}
        </p>
        {item.helpSlug && (
          <Link
            to={`/help/${item.helpSlug}`}
            className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1.5 rounded-xl transition-all hover:opacity-80"
            style={{
              background: color.replace(')', ',0.10)').replace('hsl(', 'hsla('),
              color,
              border: `1px solid ${color.replace(')', ',0.25)').replace('hsl(', 'hsla(')}`,
            }}
          >
            <BookOpen size={11} />
            {item.helpLabel || 'বিস্তারিত পড়ুন'}
            <ArrowRight size={10} />
          </Link>
        )}
      </div>

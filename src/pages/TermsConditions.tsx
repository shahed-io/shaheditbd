...
const TermsConditions = () => (
  <PolicyLayout
    ...
    seoDesc="শাহেদ স্টোর ব্যবহারের শর্তাবলী পড়ুন।"
  ...
  >
    <div className="rounded-2xl p-4 mb-6 text-[13px] leading-relaxed"
      ...
      এই Terms & Conditions শাহেদ স্টোর এবং আপনার মধ্যে একটি আইনি চুক্তি। <strong>shahedstore.com.bd</strong>-এ প্রবেশ বা যেকোনো পরিষেবা ব্যবহারের মাধ্যমে আপনি এই শর্তগুলো মেনে নিচ্ছেন।
    </div>

    <SectionCard icon={<ShoppingCart size={15} />} title="১. পরিষেবার বিবরণ" accentFrom={A} accentTo={B}>
      <p className="mb-2">শাহেদ স্টোর একটি ডিজিটাল পণ্য বিক্রয় প্ল্যাটফর্ম। আমরা বিক্রি করি:</p>

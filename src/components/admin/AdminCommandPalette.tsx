...
const AdminCommandPalette = ({ open, onClose }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[8vh] sm:pt-[12vh] px-3 sm:px-4 animate-in fade-in duration-150">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-2xl rounded-2xl overflow-hidden border border-cyan-200/60 dark:border-cyan-800/40 bg-white/95 dark:bg-cyan-950/90 backdrop-blur-xl animate-in zoom-in-95 slide-in-from-top-4 duration-200" style={{ boxShadow: '0 24px 48px hsla(258,78%,55%,0.20), 0 8px 16px hsla(258,40%,30%,0.08)' }}>
        {/* Search input */}

...
const MENU_SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: CreditCard, label: 'Uddoktapay PGW', path: '/ceo/uddoktapay-pgw', badge: 'new' },
      { icon: CreditCard, label: 'Binance Pay PGW', path: '/ceo/binance-pgw', badge: 'new' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Bot, label: 'WhatsApp Bot', path: '/ceo/whatsapp-bot', badge: 'new' },
    ],
  },
  {
    title: 'AI Tools',
            ...
            <h1 className="text-base sm:text-lg font-bold text-foreground truncate leading-tight" style={{ fontFamily: 'Sora, sans-serif', letterSpacing: '-0.01em' }}>
              ...
              <span className="sr-only">
                '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                            ...
                                            আমাদের ওয়েবসাইটটা খুব slow কাজ করছে। কোথায় কি সমস্যার সমাধান করো?
              </span>
            </h1>
          </div>

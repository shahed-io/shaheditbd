...
import {
  ...
  Zap, ImageIcon, Link2, ArrowLeftRight, Link2Off, Wallet, Sliders, Flame, Mail, Facebook, Layers, ShieldCheck, MessageCircle
} from 'lucide-react';
...
const menuItems = [
  ...
  { icon: Package, label: 'Personal Inventory', path: '/ceo/personal-licenses' },

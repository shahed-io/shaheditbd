...
const SLIDES = [
  ...
  },
  {
    ...
    badge: 'LIMITED TIME',
    // Orange/Peach theme
    bgFrom:      'hsla(22,90%,88%,1)',
    bgMid:       'hsla(15,85%,84%,1)',
    bgTo:        'hsla(38,80%,90%,1)',
    accentFrom:  'hsl(18,100%,50%)',
    accentTo:    'hsl(36,100%,48%)',
    badgeBg:     'hsl(18,100%,50%)',
    dotColor:    'hsl(18,100%,50%)',
    emoji: '📦',

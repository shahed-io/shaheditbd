...
import { ShoppingCart, Heart, Search, Menu, X, Phone, ChevronDown, Package, Star } from 'lucide-react';
      ...
      <nav className="glass-card border-b border-primary/20 px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button className="hidden sm:flex btn-glow px-4 py-2 rounded-xl text-sm items-center gap-1">
              Login
            </button>

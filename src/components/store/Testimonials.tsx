...
const HARDCODED_REVIEWS: Review[] = [
  ...
  { id: crypto.randomUUID(), name: 'Sadia Islam', location: 'Comilla', avatar: 'SI', rating: 5, review: 'Netflix Premium subscription নিয়েছি, এখন পরিবারের ৪ জন মিলে দেখছি। অনেক সাশ্রয়ী। ধন্যবাদ Shahed Store!', product: 'Netflix Premium', date: '১০ দিন আগে', verified: true, is_visible: true },

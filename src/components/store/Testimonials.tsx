...
const HARDCODED_REVIEWS: Review[] = [
  ...
  { id: crypto.randomUUID(), name: 'Sayed Hasan', location: 'Facebook Review', avatar: 'SH', rating: 5, review: 'Highly Recommend Shahed IT to Purchase MS Office product. 5★ Satisfaction.', product: 'MS Office', date: 'Jul 12, 2025', verified: true, is_visible: true },
  { id: crypto.randomUUID(), name: 'SK R', location: 'Facebook Review', avatar: 'SK', rating: 5, review: 'অনেক ভালো সার্ভিস। ধন্যবাদ Shahed IT টিম।', product: 'Verified Purchase', date: 'Jul 6, 2025', verified: true, is_visible: true },
  { id: crypto.randomUUID(), name: 'Abuturaf Mia', location: 'Facebook Review', avatar: 'AM', rating: 5, review: 'Shahed IT থেকে প্রথমে জিনিস নিতে অনেক ভয় পাইছিলাম কারণ এত কম দামে কেউ দেয় না, দিলেও বাটপারি করে। কিন্তু যখন নিলাম সত্যি তাদের কথা এবং কাজে ১০০% মিল পেয়েছি আলহামদুলিল্লাহ। তাদের ব্যবহার ও অসাধারণ।', product: 'Verified Purchase', date: 'Jun 29, 2025', verified: true, is_visible: true },

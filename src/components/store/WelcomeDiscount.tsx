...
export default function WelcomeDiscount() {
  ...
  const loadInitial = useCallback(async (forcePreview = false, forceOpen = false) => {
    ...
    if (forcePreview) {
      try {
        ...
        let popup_subtitle = 'শাহেদ স্টোর-এ স্বাগতম! শুধুমাত্র নতুন ভিজিটরদের জন্য একটি গ্যারান্টিড ছাড় — মাত্র একবার দাবি করা যাবে।';
  ...
  const popupSubtitle = settings?.popup_subtitle || 'শাহেদ স্টোর-এ স্বাগতম! শুধুমাত্র নতুন ভিজিটরদের জন্য একটি গ্যারান্টিড ছাড় — মাত্র একবার দাবি করা যাবে।';

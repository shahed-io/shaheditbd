...
import PostLoginRedirect from "@/components/store/PostLoginRedirect";
...
const AdminBinancePGW       = lazy(() => import("./pages/admin/AdminBinancePGW"));
const BinanceReturn         = lazy(() => import("./pages/BinanceReturn"));
...
const AdminDesignBackup     = lazy(() => import("./pages/admin/AdminDesignBackup"));
...
const AdminTopicalAuthority = lazy(() => import("./pages/admin/AdminTopicalAuthority"));
...
const AdminCustomerReviews       = lazy(() => import("./pages/admin/AdminReviews"));
    ...
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/binance/return" element={<Suspense fallback={<PageLoader />}><BinanceReturn /></Suspense>} />
          ...
          <Route path="/ceo" element={<AdminLayout />}>
            ...
            <Route path="binance-pgw" element={<AdminSuspense><AdminBinancePGW /></AdminSuspense>} />
            ...
            <Route path="design-backup" element={<AdminSuspense><AdminDesignBackup /></AdminSuspense>} />

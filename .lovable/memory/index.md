...
AI Card Generator (PERMANENT): all 6 styles share one blueprint — pastel diagonal mesh (lavender+pink+sky-blue+peach) + small clear soap bubbles + TRANSLUCENT GRAY-GLASS "SHAHED STORE" pill with white text (NO red badge) + white brand pill (logo + dark name) + bottom contact line inside card.

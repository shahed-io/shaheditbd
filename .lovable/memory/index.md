...
Brand name spelling by language: English → "Shahed Store", Bengali → "শাহেদ স্টোর" (correct spelling). Never use misspelled variants in either language. See [store-name-english](mem://constraints/store-name-english).
...
- [Copy protection status](mem://constraints/copy-protection-status) — FULL copy protection (right-click/copy/cut/drag/devtools-shortcuts blocked, .md/source 404, print blocked). NO page blur on devtools open. Strong bot detection (webdriver, headless, phantom). SEO bots whitelisted
